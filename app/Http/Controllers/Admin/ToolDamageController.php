...
class ToolDamageController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()->route('admin.tool-damage.index')
                ->with('status', $message);
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function edit(ToolEntry $tool_damage): View
    {
        ...
        return view('admin.tools.damage.edit', compact('entry', 'tool', 'damageTypes'));
    }
    ...
    public function update(Request $request, ToolEntry $tool_damage): RedirectResponse
    {
        ...
        try {
            ...
            // Reponer disponibilidad anterior
            ...
            return redirect()->route('admin.tool-damage.show', $tool->id)->with('status', $message);
        } catch (\Exception $e) {
            DB::rollBack();

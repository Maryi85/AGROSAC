...
<head>
    <meta charset="utf-8">
    <title>Reporte de Actividades - {{ $user->name }}</title>
    <style>
        @page {
            margin: 10mm 15mm;
        }
...
<body>
        ...
        <table class="header-table">
            <tr>
                ...
                <td style="vertical-align: middle; padding-left: 15px;">
                    ...
                    <div class="header-subtitle">Reporte de Actividades del Trabajador</div>
                </td>
                <td style="text-align: right; vertical-align: middle;">
                    <div style="font-size: 14pt; font-weight: bold; color: #333;">REPORTE OFICIAL</div>
        ...
        <table style="width: 100%;">
            <tr>
                 <td style="width: 40%;">
                    ...
                    <div style="font-size: 9pt; color: #666;">{{ $user->email }}</div>
                </td>
                <td style="width: 20%;">
                ...
                <td style="width: 20%;">
                    ...
                    <div class="user-value" style="font-size: 10pt;">{{ $user->created_at->format('d/m/Y') }}</div>
                </td>
    ...
    @if($tasks->count() > 0)
    <div class="details-section">
        <div class="section-title">Detalle de Actividades Aprobadas</div>
        <table class="data-table">
            <thead>
                <tr>
    ...
    <div style="padding: 30px; text-align: center; color: #666; font-style: italic; background-color: #f9fafb; margin-top: 20px; border-radius: 8px;">
        No hay registros de tareas aprobadas para el período seleccionado.
    </div>
    @endif
    ...
    <div class="footer">
        ...
        <br>
        Este documento es un reporte oficial de actividades y pagos generados.
    </div>

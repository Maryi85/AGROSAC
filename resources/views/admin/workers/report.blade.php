...
@section('header')
<h2 class="text-lg font-semibold text-emerald-700">Reporte de Trabajador</h2>
@endsection
    ...
    <div class="mb-6 pb-6 border-b">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <p class="text-lg text-gray-900 mt-1">{{ $worker->name }}</p>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">Email</label>
                <p class="text-lg text-gray-900 mt-1">{{ $worker->email }}</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-lg text-gray-900 mt-1">{{ $worker->created_at->format('d/m/Y H:i') }}</p>
            </div>
        </div>
    </div>

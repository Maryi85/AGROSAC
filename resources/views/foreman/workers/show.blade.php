...
<div class="bg-white border rounded p-4">
    <div class="space-y-6">
        ...
        <div class="bg-gray-50 rounded p-4">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('foreman.workers.tasks', $worker) }}" class="text-sm text-emerald-600 hover:text-emerald-700">Ver todas</a>
            </div>
        ...
        <div class="bg-blue-50 rounded p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="bg-white rounded p-4 border">
                    ...
                    <a href="{{ route('foreman.workers.tasks', $worker) }}" 
                ...
                <div class="bg-white rounded p-4 border">
                    ...
                    <a href="{{ route('foreman.workers.edit', $worker) }}" 
                ...
                <div class="bg-white rounded p-4 border">
                    ...
                    <form method="POST" action="{{ route('foreman.workers.reset-password', $worker) }}" class="inline" data-confirm="true" data-message="¿Restablecer la contraseña de este trabajador? Se generará una nueva contraseña temporal.">
                        @csrf
                ...
                <div class="bg-white rounded p-4 border">
                    ...
                    <form method="POST" action="{{ route('foreman.workers.toggle-status', $worker) }}" class="inline" data-confirm="true" data-message="{{ $worker->email_verified_at ? '¿Desactivar este trabajador?' : '¿Activar este trabajador?' }}">
                        @csrf
    ...
    <div class="mt-6 flex justify-between">
        <a href="{{ route('foreman.workers.index') }}" 

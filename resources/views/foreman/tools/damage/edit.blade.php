...
<div class="flex items-center justify-between">
    ...
    <a href="{{ route('foreman.tool-damage.show', $tool->id) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-200 rounded transition-colors">
...
@section('content')
<form method="POST" action="{{ route('foreman.tool-damage.update', $entry->id) }}" class="space-y-6" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="flex justify-end gap-4 pt-6 border-t">
        <a href="{{ route('foreman.tool-damage.show', $tool->id) }}" 

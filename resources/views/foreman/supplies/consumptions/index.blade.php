...
<div class="bg-white border rounded p-4">
    ...
    <div class="flex justify-between items-center mb-6 gap-4">
        ...
        <a href="{{ route('foreman.supply-consumptions.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg whitespace-nowrap">
                ...
                <tr class="border-b hover:bg-gray-50" data-consumption-id="{{ $consumption->id }}">
                    ...
                    <td class="py-3 pr-4 text-right">
                        <div class="flex items-center gap-1 justify-end">
                            ...
                            <!-- Eliminar -->
                            <form method="POST" action="{{ route('foreman.supply-consumptions.destroy', $consumption) }}" class="inline" data-confirm="true" data-message="¿Eliminar este consumo? Esta acción no se puede deshacer.">
                                @csrf
                                @method('DELETE')

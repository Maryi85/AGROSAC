...
<div class="bg-white border rounded p-4">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 gap-3">
        ...
        <a href="{{ route('foreman.supply-consumptions.create') }}" class="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg">
...
function openEditModal(id, supplyId, qty, cropId, plotId, taskId, usedAt) {
    ...
    form.action = `/foreman/supply-consumptions/${id}`;

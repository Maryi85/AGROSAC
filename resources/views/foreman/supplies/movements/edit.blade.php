...
<div class="flex items-center justify-between">
    ...
    <a href="{{ route('foreman.supply-movements.index') }}" class="inline-flex items-center gap-2 px-4 py-2 border border-emerald-300 rounded text-emerald-700 hover:bg-emerald-100">
...
<div class="bg-white border rounded p-6">
    ...
    <form method="POST" action="{{ route('foreman.supply-movements.update', $supplyMovement) }}" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end gap-4 pt-6 border-t">
            <a href="{{ route('foreman.supply-movements.index') }}" 

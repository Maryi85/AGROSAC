            ...
            @forelse($tasks as $task)
                <tr>
                    ...
                    <td>
                        ...
                        <div style="font-size: 8pt; color: #666;">{{ ucfirst($task->type) ?? '' }}</div>
                    </td>
                    ...
                    <td>{{ $task->scheduled_for ? $task->scheduled_for->format('d/m/Y') : 'N/A' }}</td>
                    ...
                    <td class="text-right font-bold">
                        ${{ number_format($task->total_payment ?? 0, 0) }}
                    </td>
                </tr>
            @empty
                <tr>

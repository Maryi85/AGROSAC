...
use App\Http\Controllers\ForemanToolEntryController;
use App\Http\Controllers\ForemanToolDamageController;
use App\Http\Controllers\ForemanSupplyController;
use App\Http\Controllers\ForemanSupplyConsumptionController;
use App\Http\Controllers\ForemanSupplyMovementController;
...
Route::middleware(['auth', 'user.active', 'role:foreman'])->prefix('foreman')->name('foreman.')->group(function () {
    ...
    Route::get('loans', [ForemanLoanController::class, 'index'])->name('loans.index');
    Route::get('loans/{loan}', [ForemanLoanController::class, 'show'])->name('loans.show');
